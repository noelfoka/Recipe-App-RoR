...
class RecipesFoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recipes_food" do
    assert_difference("RecipesFood.count") do
      post recipes_foods_url, params: { recipes_food: { measurement_unit: @recipes_food.measurement_unit, name: @recipes_food.name, price: @recipes_food.price, quantity: @recipes_food.quantity } }
    end
  ...
  test "should update recipes_food" do
    patch recipes_food_url(@recipes_food), params: { recipes_food: { measurement_unit: @recipes_food.measurement_unit, name: @recipes_food.name, price: @recipes_food.price, quantity: @recipes_food.quantity } }
